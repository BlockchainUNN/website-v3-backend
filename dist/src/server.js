...
const rawData = (0, fs_1.readFileSync)("./src/swagger/swagger-output.json", "utf-8");
...
// Default Route
app.get("/", (req, res) => {
    res.send(`<div>View API Documentation @ <a href="http://${EXTERNAL_HOST}/api/v3/doc">${EXTERNAL_HOST}/api/v3/doc</a><div>`);
});
// ROUTES HERE
