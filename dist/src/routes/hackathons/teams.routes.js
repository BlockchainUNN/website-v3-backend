 ...
 */
teamsRoutes.post("/hackathon/team/:id", auth_1.authenticate, (0, validation_1.validate)(CreateTeamSchema), teams_controllers_1.default.create);
/**
 * @swagger
 ...
 */
teamsRoutes.post("/hackathon/team/join/:id", auth_1.authenticate, (0, validation_1.validate)(JoinTeamSchema), teams_controllers_1.default.join);
/**
 * @swagger
 * /api/v3/hackathon/team/{id}:
 *   get:
 ...
 */
teamsRoutes.get("/hackathon/team/:id", auth_1.authenticate, (0, validation_1.validate)(HackathonParamSchema), teams_controllers_1.default.getTeam);
/**
 * @swagger
 * /api/v3/hackathon/team/{id}:
 *   delete:
 ...
 *         description: Hackathon not found or user not registered
 */
teamsRoutes.delete("/hackathon/team/:id", auth_1.authenticate, (0, validation_1.validate)(HackathonParamSchema), teams_controllers_1.default.leaveTeam);
