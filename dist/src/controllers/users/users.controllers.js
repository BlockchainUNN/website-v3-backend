...
const create = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (
        phoneNumber &&
        !(0, validationHandlers_1.isValidPhoneNumber)(phoneNumber)
      )
        return (0, responseHandlers_1.errorResponse)(
          res,
          400,
      ...
      if (existingUser) {
        ...
        const response = yield (0, mailHandler_1.sendMail)(
          email,
          "Welcome Back",
          "onboarding",
          {}
      ...
      // Handle image upload
      if (profilePic) {
        uploadedImage = yield (0, imageUploadHandler_1.uploadSingleImage)(
          profilePic
        );
      ...
      const newUser = yield client_1.default.user.create({
        data: {
          ...
          gender: gender,
          profile_pic:
            profilePic_db === null || profilePic_db === void 0
              ? void 0
              : profilePic_db.id,
        },
      });
      ...
      return (0,
      responseHandlers_1.successResponse)(res, 201, "Successful Registration. Community Links have been sent to email address.", {
        email: newUser.email,
      ...
      return (0,
      responseHandlers_1.errorResponse)(res, 500, "Internal Error", { details: error });
    }
  });
const getUsers = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      return (0,
      responseHandlers_1.successResponse)(res, 200, "user retrieved successfully", users);
    } catch (error) {
      // #swagger.responses[500] = {description: 'Internal server error', schema: {error: 'Internal server error', data: {details: "If more info is available it will be here."}}}
      return (0,
      responseHandlers_1.errorResponse)(res, 500, "An error occurred while fetching users", error);
    }
  });
const getUserDetails = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      return (0,
      responseHandlers_1.successResponse)(res, 200, "User details retrieved succesfully", user);
    } catch (error) {
      // #swagger.responses[500] = {description: 'Internal server error', schema: {error: 'Internal server error', data: {details: "If more info is available it will be here."}}}
      (0,
      responseHandlers_1.errorResponse)(res, 500, "An Error occured fetching user details", error);
    }
  });
