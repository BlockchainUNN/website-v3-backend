...
import blogController from "../../controllers/blog/blog.contoller";
...
blogRoutes.post(
  "/blog/posts",
  authenticate,
  requirePermission(Permission.CREATE_BLOG_POST),
  ...
  validateMultipart(CreateBlogPostSchema),
...
blogRoutes.put(
  "/blog/posts/:id",
  authenticate,
  requirePermission(Permission.UPDATE_BLOG_POST),
  upload.single("previewImage"),
  validateFileUpload({
    allowedMimeTypes: ["image/jpeg", "image/png", "image/webp"],
    maxFileSize: 5 * 1024 * 1024, // 5MB
  ...
  validate(ParamIdSchema),
  validateMultipart(UpdateBlogPostSchema),
...
blogRoutes.delete(
  "/blog/posts/:id",
  authenticate,
  requirePermission(Permission.DELETE_BLOG_POST),
  validate(ParamIdSchema),
...
blogRoutes.get(
  "/blog/authors/:id",
  validate(ParamIdSchema),
  blogController.getBlogAuthorById
);
...
blogRoutes.post(
  "/blog/authors",
  authenticate,
  requirePermission(Permission.CREATE_BLOG_POST), // Using same permission as blog posts
  validate(CreateBlogAuthorSchema),
  blogController.createBlogAuthor
);
...
blogRoutes.put(
  "/blog/authors/:id",
  authenticate,
  requirePermission(Permission.UPDATE_BLOG_POST), // Using same permission as blog posts
  validate(ParamIdSchema),
  validate(UpdateBlogAuthorSchema),
  blogController.updateBlogAuthor
);
...
blogRoutes.delete(
  "/blog/authors/:id",
  authenticate,
  requirePermission(Permission.DELETE_BLOG_POST), // Using same permission as blog posts
  validate(ParamIdSchema),
  blogController.deleteBlogAuthor
);
